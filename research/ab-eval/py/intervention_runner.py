...
def main():
    ...
    parser.add_argument("--exp", choices=["prompt_v3", "prompt_v3_2", "prompt_v3_3", "render_v3", "full_v3", "full_v3_2", "full_v3_3", "baseline_v2"], required=True)
    ...
    prompt_type = "v3_3" if "v3_3" in args.exp else ("v3_2" if "v3_2" in args.exp else ("v3" if "prompt" in args.exp or "full" in args.exp else "v2"))
